...
class HospitalUI:
    ...
    """
    menu_options = ["Exit", "Add a new department to the repository", "Update a department with a given ID",
                    "Update a patient with a given name", "Delete a department with a given ID",
                    "Delete a patient with a given name",
                    "Return the departments with the number of patients lower than a given number",
                    "Return the patients with the name starting with a given string",
                    "Return the departments that have a given number of beds"]
