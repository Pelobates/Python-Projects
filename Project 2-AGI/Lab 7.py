...
def Input(x,y):
    pointNum = int(input("Introduceti numarul punctelor de control dorite: "))
    for i in range(pointNum):
        x.append(int(input("Introduceti datele " + str(i + 1) + "x este punct de control: ")))
        y.append(int(input("Introduceti datele " + str(i + 1) + "y este punct de control: ")))
    return
